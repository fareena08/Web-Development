...
include_once 'booking_details_crud.php';
      ...
      <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
        <div class="panel panel-default"><center>
          ...
          <form action="booking_details.php" method="POST">
            ...
            <input type="submit" class="btn btn-outline-danger" name="reject"  value="Reject" role="button" style="background-color: red" onclick="return confirm('Are you sure to reject this booking?');"></>
          </form>
        </td>
        </div>
        </center>
