<?php
include 'validate_loginuser.php';
...
<div class="container-fluid">
  <div class="row">
	  <div class="col-12 col-md-4 offset-md-1" >
              ...
              <!-- <div class="custom-control custom-checkbox my-4">
                ...
                <label class="custom-control-label" for="customCheck2">Remember me</label>
						...
						<p class="small my-4 text-center">Didn't have an account? <a href="Register/registerUser.php">Sign Up</a>.</p>
		  		</div>
	  </div>
	  ...
	  <!-- <div class="col-12 col-md-6 offset-md-1 d-flex">
		  	<img src="" class="full-picture flex-grow-1"> 
		  </div> -->
	  </div>
  </div>
</div>
