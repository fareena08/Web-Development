<?php
include_once 'registerUser_crud.php';
include "validateRegisterUser.php";
...
<div class="container-fluid">
  <div class="row">
               ...
               <div class="form-group">
						       ...
						       <input name="cAddr" type="text" class="form-control" id="cAddr" required>
								...
								<div class="form-group">
									...
									<input name="cEmail" type="text" class="form-control" id="cEmail" placeholder="Enter email" required>
	  ...
	  <div class="col-12 col-md-6 offset-md-1 d-flex">
	  	<img src="img/cleaning1.jpg" class="full-picture flex-grow-1">
	  </div>
  </div>
</div>
